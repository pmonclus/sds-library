...
The library has **400+ tests** across C and Python, achieving **~80% code coverage**.

| Category | Tests | MQTT Broker | Runtime |
|----------|-------|-------------|---------|
| Unit Tests (C, Mock) | 220+ | No | ~0.5s |
| Integration Tests (C) | ~36 | Yes | ~60s |
| Python Tests | 154 | Yes | ~30s |
...
| Raw Subscribe API | subscribe/unsubscribe, sds/ prefix rejection, wildcard matching |
